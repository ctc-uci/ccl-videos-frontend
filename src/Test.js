...
const Test = () => {
  ...
  return (
    <div>
      <h1>
        GENERAL TODOS: footer, landing page, code activation, error/success
        alert banner usage
      </h1>
      <h2 className="help-text">
        admin login. TODO: flow is sus and incomplete, need to store isAdmin
        state in frontend to change navbar
      </h2>
      <AdminLogin />
      <h2 className="help-text">
        display lessons. TODO: styles + button functionality
      </h2>
      <DisplayLessons />
      ...
      <h2 className="help-text">
        customer video player. TODO: text should be left-aligned
      </h2>
      <VideoPlayer
        url={DUMMY_DATA.url}
      ...
      />
      <h2 className="help-text">
        common modals. TODO: styling, updating hyperlinks, get lesson activation
        to work + email reminder service. Email field should be required field.
      </h2>
